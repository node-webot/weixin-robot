...
Info.REQ_TYPES = ['text', 'image', 'location', 'link'];

function caplitalize(t) {
  return t[0].toUpperCase() + t.slice(1).toLowerCase();
}
Info.REQ_TYPES.forEach(function(t) {
  Info.prototype['is_' + t] = Info.prototype['is' + caplitalize(t)] = function() {
    return this.MsgType === t;
  };
});
